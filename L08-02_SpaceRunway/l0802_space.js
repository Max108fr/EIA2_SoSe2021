...
(function (SpaceRunway) {
    ...
    function handleLoad(_event) {
        ...
        let horizon = crc2.canvas.height * 0.8;
        drawBackground();
    ...
    function drawCloud01(_position, _size) {
    ...
    function drawCloud02(_position, _size) {
    ...
    function drawRunway(_position, _widthBack, _widthFront) {
    ...
    function drawLights1(_position) {
        console.log("draw lights", _position);
        let r1 = 4;
        let r2 = 12;
        let gradient = crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawLights2(_position) {
        console.log("draw lights", _position);
        let r1 = 6;
        let r2 = 14;
        let gradient = crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawLights3(_position) {
        console.log("draw lights", _position);
        let r1 = 8;
        let r2 = 16;
        let gradient = crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawLights4(_position) {
        console.log("draw lights", _position);
        let r1 = 10;
        let r2 = 18;
        let gradient = crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawLights5(_position) {
        console.log("draw lights", _position);
        let r1 = 12;
        let r2 = 20;
        let gradient = crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
...
})(SpaceRunway || (SpaceRunway = {}));
//# sourceMappingURL=l0802_space.js.map